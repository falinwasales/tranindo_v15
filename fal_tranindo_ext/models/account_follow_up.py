...
class AccountFollowupReport(models.AbstractModel):
    ...
    boolean_followup = fields.Boolean(string="Boolean", compute="_get_lines")
    ...
    def _get_columns_name(self, options):
        ...
        headers = [{},
                    ...
                    {'name': _('Testing'), 'class': 'date', 'style': 'text-align:right; white-space:nowrap;'}
                ]
    ...
    def _get_lines(self, options, line_id=None):
        ...
        for currency, aml_recs in res.items():
            ...
            for aml in aml_recs:
                ...
                if is_overdue:
                    date_due = {'name': date_due, 'class': 'color-red date due_date', 'style': 'white-space:nowrap;text-align:center;color: red;'}
                    aml.follow_block = False
                if is_payment:
                    date_due = ''
